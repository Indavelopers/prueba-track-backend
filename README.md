...
3. Microservicios:
   1. Sigue las instrucciones específicas para cada microservicio incluidas en los archivos correspondientes, si las hay.
   ...
   3. **servicio-fe**: API restful HTTP desarrollada en Java con Vert.x, en `GET /catalogue` devuelve un listado de productos recogido de Cloud Firestore en HTML, o eleva una excepción si ha habido algún error.
